...
def train_transformer(train_iter, net, model_dim, batch_num, en_vocab, ch_vocab, devices):
...
if __name__ == '__main__':
    ...
    devices = get_device()
    train_transformer(train_iter, net, model_dim, batch_num, en_vocab, ch_vocab, devices)
